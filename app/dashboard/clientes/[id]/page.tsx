    ...
    <div className="space-y-6">
      ...
      <div className="grid gap-6 lg:grid-cols-3">
        ...
        <div className="lg:col-span-2 space-y-6">
          ...
          {/* Card de Resumo Financeiro - Aqui irá a seção de gestão de obras */}
          <Card>
            <CardHeader className="pb-3">
              <CardTitle className="text-base">VALOR CONTRATUAL X VALOR DA OBRA</CardTitle>
              <CardDescription>Resumo das obras do cliente</CardDescription>
            </CardHeader>
            <CardContent>
              <div className="grid grid-cols-3 gap-4">
                <div className="text-center space-y-2">
                  <Building2 className="h-8 w-8 mx-auto text-[#F5C800]" />
                ...
                <div className="text-center space-y-2">
                  ...
                  <p className="text-2xl font-bold text-green-600">{obrasFinalizadas}</p>
                  <p className="text-sm text-muted-foreground">Finalizadas</p>
                </div>
                
                <div className="text-center space-y-2">
                  <Clock className="h-8 w-8 mx-auto text-orange-600" />
                  <p className="text-2xl font-bold text-orange-600">{obrasEmAndamento}</p>
                  <p className="text-sm text-muted-foreground">Em Andamento</p>
                </div>
              </div>
                    ...
                    <div className="flex items-start justify-between gap-4">
                      <div className="space-y-2 flex-1">
                        <div className="flex items-center gap-3">
                          ...
                          <h3 className="text-base font-semibold">{obra.nome}</h3>
                        </div>
                        {obra.descricao && (

...
export default async function FluxoPage() {
    ...
    return <FluxoPageContent metrics={metrics} pagamentos={pagamentos} categories={categoryOptions} subcategories={subcategoriasData || []} userPermissions={userPermissions} />
}

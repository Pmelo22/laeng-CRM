...
import ReceitaPageContent from "@/components/pagamentos/receita-page-content"
...
export default async function ReceitaPage() {
    ...
    return <ReceitaPageContent metrics={metrics} pagamentos={pagamentos} categories={categoryOptions} subcategories={subcategoriasData || []} userPermissions={userPermissions} />
}
